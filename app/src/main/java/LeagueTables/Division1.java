...
public class Division1 extends AppCompatActivity {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.nav_home:
                        Intent intent = new Intent(Division1.this, HomePage.class);
                        startActivity(intent);
                        break;

                    case R.id.nav_table:
                        Intent intent2 = new Intent(Division1.this, Division1.class);
                        startActivity(intent2);
                        break;

                    case R.id.nav_club:
                        Intent intent3 = new Intent(Division1.this, Fixtures.class);
                        startActivity(intent3);
                        break;

                    case R.id.nav_inbox:
                        Intent intent4 = new Intent(Division1.this, Inbox.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.division1:
                Intent intent = new Intent(Division1.this, Division1.class);
                startActivity(intent);
                break;
            case R.id.division2:
                Intent intent2 = new Intent(Division1.this, Division2.class);
                startActivity(intent2);
                break;
            case R.id.division3:
                Intent intent3 = new Intent(Division1.this, Division3.class);
                startActivity(intent3);
                break;
            case R.id.division4:
                Intent intent4 = new Intent(Division1.this, Division4.class);
                startActivity(intent4);
                break;
            case R.id.division5:
                Intent intent5 = new Intent(Division1.this, Division5.class);
